...
namespace DirecLayer
{
    public class SystemSettings
    {
        ...
        #region SystemTask
        public static void EndTask(string sTask)
        {
            try
            {
        ...
        public static string PathExist(string sPath)
        {
            var output = sPath.EndsWith(@"\") ? sPath : $@"{sPath}\";

            if (FolderExist(output) == false)
            { Directory.CreateDirectory(output); }

            return output;
        }

        public static string GetFileName(string sPath, bool withExtention = false)
        {
            if (withExtention)
            {
        ...
        public static FileInfo[] FileList(string sPath, string sFileParameter)
        {
